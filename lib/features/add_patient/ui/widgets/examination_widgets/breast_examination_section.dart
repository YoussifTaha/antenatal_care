  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        verticalSpace(10),
        InfoInputField(
            controller: examinationInputControllers.sizeController,
        ...
        verticalSpace(10),
        InfoInputField(
            controller: examinationInputControllers.skinTemperatureController,
            type: TextInputType.text,
            validationMessage: 'This Field Cannot Be Empty'),
        verticalSpace(20),
        Text(
        ...
        verticalSpace(10),
        InfoInputField(
            controller: examinationInputControllers.primaryAreolaController,
            type: TextInputType.text,
            validationMessage: 'This Field Cannot Be Empty'),
        verticalSpace(20),
        Text(
        ...
        verticalSpace(10),
        InfoInputField(
            controller: examinationInputControllers.secondaryAreolaController,
            type: TextInputType.text,
            validationMessage: 'This Field Cannot Be Empty'),
      ],
    );
